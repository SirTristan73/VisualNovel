...
namespace EventBus
{
    ...
    {
        public static event Action<Dictionary<string, (string characterName, string text)>, Dictionary<string, string>> OnChangeLanguage;
        ...
        private Dictionary<string, (string characterName, string text)> _currentDialogueTexts;
        public Dictionary<string, (string characterName, string text)> CurrentDialogueTexts => _currentDialogueTexts;
        ...
        public void SetTextLanguage(LanguageState language)
        {
            ...
            {
                _currentDialogueTexts = GetDialogueTexts(type);
